...
public:
	...
	ComPtr<ID3D11ShaderResourceView>	mDepthShaderView = nullptr; // Allows access to the depth buffer as a texture for certain specialised shaders
	...
	ID3D11SamplerState* mPointSamplerBorder = nullptr;
