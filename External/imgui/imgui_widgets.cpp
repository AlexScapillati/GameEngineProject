...
bool ImGui::ButtonBehavior(const ImRect& bb, ImGuiID id, bool* out_hovered, bool* out_held, ImGuiButtonFlags flags)
{
    ...
    CWindow* backup_hovered_window = g.HoveredWindow;
...
ImGuiID ImGui::GetWindowScrollbarID(CWindow* window, ImGuiAxis axis)
{
    return window->GetIDNoKeepAlive(axis == ImGuiAxis_X ? "#SCROLLX" : "#SCROLLY");
}

// Return scrollbar rectangle, must only be called for corresponding axis if window->ScrollbarX/Y is set.
ImRect ImGui::GetWindowScrollbarRect(CWindow* window, ImGuiAxis axis)
{
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
    ...
    if (CWindow* popup_window = FindWindowByName(name))
...
bool ImGui::ColorEdit4(const char* label, float col[4], ImGuiColorEditFlags flags)
{
    ...
    CWindow* picker_active_window = NULL;
...
void ImGui::EndMenuBar()
{
    ...
    {
        CWindow* nav_earliest_child = g.NavWindow;
...
bool ImGui::BeginMainMenuBar()
{
    ...
    CWindow* menu_bar_window = FindWindowByName("##MainMenuBar");
...
bool ImGui::BeginMenu(const char* label, bool enabled)
{
    ...
    CWindow* backed_nav_window = g.NavWindow;
    if (menuset_is_open)
    ...
    if (window->DC.LayoutType == ImGuiLayoutType_Vertical) // (window->Flags & (ImGuiWindowFlags_Popup|ImGuiWindowFlags_ChildMenu))
    {
        ...
        CWindow* child_menu_window = (g.BeginPopupStack.Size < g.OpenPopupStack.Size && g.OpenPopupStack[g.BeginPopupStack.Size].SourceWindow == window) ? g.OpenPopupStack[g.BeginPopupStack.Size].Window : NULL;
...
namespace ImGui
{
    ...
    static ImU32            TabBarCalcTabID(ImGuiTabBar* tab_bar, const char* label, CWindow* docked_window);
...
static ImU32   ImGui::TabBarCalcTabID(ImGuiTabBar* tab_bar, const char* label, CWindow* docked_window)
{
...
void ImGui::TabBarAddTab(ImGuiTabBar* tab_bar, ImGuiTabItemFlags tab_flags, CWindow* window)
{
    ImGuiContext& g = *GImGui;
...
bool    ImGui::TabItemEx(ImGuiTabBar* tab_bar, const char* label, bool* p_open, ImGuiTabItemFlags flags, CWindow* docked_window)
{
...
void    ImGui::SetTabItemClosed(const char* label)
{
    ...
    else if (CWindow* window = FindWindowByName(label))
    {
