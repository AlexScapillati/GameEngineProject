...
// Helper
inline ImGuiTableFlags TableFixFlags(ImGuiTableFlags flags, CWindow* outer_window)
{
    ...
    CWindow* window_for_settings = outer_window->RootWindowDockStop;
#else
...
{
    ImGuiContext& g = *GImGui;
    CWindow* outer_window = GetCurrentWindow();
    ...
    CWindow* inner_window = table->InnerWindow;
...
void    ImGui::EndTable()
{
    ...
    CWindow* inner_window = table->InnerWindow;
    CWindow* outer_window = table->OuterWindow;
...
{
    CWindow* window = table->InnerWindow;
...
void ImGui::SetWindowClipRectBeforeSetChannel(CWindow* window, const ImRect& clip_rect)
{
...
ImGuiOldColumns* ImGui::FindOrCreateColumns(CWindow* window, ImGuiID id)
{
