...
bool CLevelImporter::LoadScene(const std::string& level, CDX11Scene* scene)
{
...
void CLevelImporter::SaveScene(std::string& fileName /* ="" */, CDX11Scene* ptrScene)
{
	if (fileName.empty())
	{
...
void CLevelImporter::SavePositionRotationScale(tinyxml2::XMLElement* obj, CDX11GameObject* it)
{
...
void CLevelImporter::SaveObjects(tinyxml2::XMLElement* el, CDX11Scene* ptrScene)
{
	//----------------------------------------------------
	//	Game Objects
	//----------------------------------------------------
...
bool CLevelImporter::ParseScene(tinyxml2::XMLElement* sceneEl, CDX11Scene* scene)
{
...
void CLevelImporter::LoadObject(tinyxml2::XMLElement* currEntity, CDX11Scene* scene)
{
	std::string ID;
	std::string mesh;
	std::string name;
...
void CLevelImporter::LoadPointLight(tinyxml2::XMLElement* currEntity, CDX11Scene* scene)
{
	std::string mesh;
	std::string name;
	std::string diffuse;
...
void CLevelImporter::LoadLight(tinyxml2::XMLElement* currEntity, CDX11Scene* scene)
{
	std::string mesh;
	std::string name;
	std::string diffuse;
...
void CLevelImporter::LoadSpotLight(tinyxml2::XMLElement* currEntity, CDX11Scene* scene)
{
	std::string mesh;
	std::string name;
	std::string diffuse;
...
void CLevelImporter::LoadDirLight(tinyxml2::XMLElement* currEntity, CDX11Scene* scene)
{
	std::string mesh;
	std::string name;
	std::string diffuse;
...
void CLevelImporter::LoadSky(tinyxml2::XMLElement* currEntity, CDX11Scene* scene)
{
	std::string mesh;
	std::string name;
	std::string diffuse;
...
void CLevelImporter::LoadCamera(tinyxml2::XMLElement* currEntity, CDX11Scene* scene)
{
	std::string mesh;
	std::string diffuse;
...
void CLevelImporter::LoadPlant(tinyxml2::XMLElement* currEntity, CDX11Scene* scene)
{
	std::string ID;
	std::string mesh;
	std::string name;
...
void CLevelImporter::SavePostProcessingEffect(tinyxml2::XMLElement* curr, CDX11Scene* scene)
{
...
void CLevelImporter::ParsePostProcessingEffects(tinyxml2::XMLElement* curr, CDX11Scene* scene)
{
...
bool CLevelImporter::ParseEntities(tinyxml2::XMLElement* entitiesEl, CDX11Scene* scene)
{
